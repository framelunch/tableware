...
Oe.prototype = {
    ...
    show: function () { return this.hidden(false); },
    hide: function () { return this.hidden(true); },
    ...
    clientTop: function () {
        return this.length ? this[0].clientTop : 0;
    },
    clientLeft: function () {
        return this.length ? this[0].clientLeft : 0;
    },
    offsetTop: function () {
    ...
    hasClass: function (val) {
        return this.length ? (this[0].className.indexOf(val)>-1) : false;
    },
    ...
    insertBefore: function () {
        if (this.length) {
            ...
            for(i; i<l; i++) {
                o = arguments[i];
                if (typeof o === 'string') {
                    ref.parentNode.insertBefore(Oe(o)[0], ref);
                } else {
                    o.each(function (item) {
    ...
    insertAfter: function (node) {
        if (this.length) {
            ...
            for(i; i<l; i++) {
                o = arguments[i];
                if (typeof o === 'string') {
                    ref.parentNode.insertBefore(Oe(o)[0], ref.nextSibling);
                } else {
                    o.each(function (item) {
