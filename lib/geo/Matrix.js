...
var
    ...
    Matrix = function (a,b,c,d,tx,ty) {
        this.a = isEmpty(a)?1:a;
        this.b = isEmpty(b)?0:b;
        this.c = isEmpty(c)?0:c;
        this.d = isEmpty(d)?1:d;
        this.tx = isEmpty(tx)?0:tx;
        this.ty = isEmpty(ty)?0:ty;
    };
...
Matrix.prototype = {
    ...
    diff: function (mtx) {
        return new Matrix(
            this.a-mtx.a, this.b-mtx.b,
            this.c-mtx.c, this.d-mtx.d,
            this.tx-mtx.tx, this.ty-mtx.ty
        );
    }
};
