...
var
    ...
    body = (function () {
        ...
        root +=
            '<div class="mDatePicker_box">' +
            '<button class="mDatePicker_prev"><</button>' +
            '<button class="mDatePicker_next">></button>' +
            '<span class="mDatePicker_title"></span>' +
            '</div>';

        root += '<table><tr class="mDatePicker_weeks">';
        for(i=0; i<7; i++) {
            root += '<th class="mDatePicker_week dp-week-'+i+'">' + weeks[i] + '</th>';
        }
        root += '</tr>';
