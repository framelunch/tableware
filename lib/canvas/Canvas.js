...
Canvas.prototype = {
    ...
    update:function()
    {
        if (!this.__d) {
            this.__d = 1;
            animationFrame(this.__update.bind(this));
        }
        return this;
    },
    __update:function()
    ...
    __setEvent:function()
    {
        ...
        if(isTouch){
            event = this.__touchEvent.bind(this);
            e.addEventListener('touchstart', event);
            e.addEventListener('touchmove', event);
            e.addEventListener('touchend', this.__touchEnd.bind(this));
        }else{
            event = this.__mouseEvent.bind(this);
